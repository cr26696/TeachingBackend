<template>
	<el-table :data="itemsToDisplay">
		<el-table-column type="selection" :width="selectorWidth"></el-table-column>
		<el-table-column v-for="(item, index) in fieldInfos" :prop="item[0]" :key="index" :label="item[1]" :min-width="flexColumnWidth(item[0], itemsToDisplay)" :max-width="60">
		</el-table-column>
	</el-table>
</template>
<script>
export default {
	name: 'DataListTableNoScroll',
	props: {
